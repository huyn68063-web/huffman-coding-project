...
Chương trình nén dữ liệu bằng thuật toán Huffman Coding (chiến lược tham lam) - C++ &amp; Web UI
...
Kiem tra giai ma: [OK] Dung khop voi ban goc

--- KET QUA NEN ---
Kich thuoc goc      : 168 bit
Kich thuoc sau nen  : 41 bit
Ty le nen           : 75.60 %
```
...
| Thành viên | Nhiệm vụ |
|---|---|
| Thành viên 4 | Cài đặt thuật toán Huffman Coding (`huffman.h`, `huffman.cpp`) |
| Thành viên 5 | Thiết kế giao diện chương trình (`main.cpp`) |
